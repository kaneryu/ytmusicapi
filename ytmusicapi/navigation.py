...
SINGLE_COLUMN_WATCH_NEXT_TAB = SINGLE_COLUMN_WATCH_NEXT + ["tabbedRenderer", "watchNextTabbedResultsRenderer"] + TAB_CONTENT
...
MRLIFCR_TEXT = [MRLIFCR, "text", "runs", 0, "text"]
MRLIFCR_BROWSEID = [MRLIFCR, "text", "runs", 0, "navigationEndpoint", "browseEndpoint", "browseId"]
